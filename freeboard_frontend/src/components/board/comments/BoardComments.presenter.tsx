...
const BoardCommentsPresenter:React.FC<IboardCommentsProps> = ({rating, handleSaveRating, comment, handleComment, submitComment, commentLists}) => {
  return (
    <Main>
      <BoardContainer>
        <CmntTitleWrapper>
        ...
        <CmntLists>
          {commentLists?.map((list) => (<CmntList key={list._id}>
